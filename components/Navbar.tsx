  ...
  return (
    <nav
      style={{
        ...
        right: 0,
        zIndex: 100,
        background: scrolled ? "rgba(15,26,46,0.97)" : "transparent",
    ...
    >
      ...
      >
        ...
        <Link href="#home" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          >
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              <circle cx="11" cy="11" r="9" stroke="#C8A84B" strokeWidth="1.5" fill="none"/>
              <circle cx="11" cy="11" r="4" fill="#C8A84B"/>
            </svg>
          </div>
          <div>
            <div style={{ color: "#C8A84B", fontFamily: "'Playfair Display', serif", fontSize: "1rem", fontWeight: 600, lineHeight: 1.1 }}>Rotaract</div>
        ...
        <button
          ...
          style={{ background: "none", border: "none", cursor: "pointer", color: "#C8A84B", display: "none" }}
